...
#define POV_ODDS_FROM_EV 0x4
#define NONPOV_ODDS_FROM_REGS 0x8
#define NONPOV_ODDS_FROM_AVG 0x10
#define NONPOV_ODDS_FROM_EV 0x20
#define UPDATE_EV 0x40
#define UPDATE_AVG_ODDS 0x80
#define UPDATE_REGS 0x100
#define REGS_DECAY 0x200
#define NONPOV_UPDATE_HAND_VISITS 0x400
#define POV_UPDATE_VISITS 0x800
#define NONPOV_UPDATE_VISITS 0x1000
...
struct situ
{
  //uint16_t *hand_odds[ACTS-1];
  double *regs[ACTS];
  //float *d_regs[ACTS];
  double *avg_odds[ACTS];
  double *ev[ACTS-1];
  uint32_t *ev_count[ACTS-1];
  //  double *avg_odds_diff;
  //uint32_t *avg_odds_diff_count;
  //double *visits;
  //uint64_t *timestamp;
  //struct plrmodel_node *parent;
};
