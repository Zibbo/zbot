...
def rnd_func():
    ...
    return np.array((pub_types[9],pub_types[8]), dtype=np.int16)
...
diffs, diffs_order, types = zp.get_group_with_biggest_diffs(2**13, (2,), rnd_func, dist_func2, False)

diffs.tofile("turn_board.diffs")
types.tofile("turn_board.types")
