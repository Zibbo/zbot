...
hand_values = numpy.zeros((zp.HANDS), dtype=dt.hand_hv_np)
cont = True
i = 0
while cont:
    i+=1
    ...
    lzp.lib.get_river_hand_hv_all(lzp.ctoi3[board[0]][board[1]][board[2]], board[3], board[4], hand_values.ctypes.data_as(POINTER(dt.hand_hv)))
